...
import static dreamlab.worldpics.util.DownloadHelper.DownloadType.DOWNLOAD;

public class DownloadHelper {

    public static final String DOWNLOAD_PATH = "/Pictures/WorldPics/";
    ...
    public long addDownloadRequest(@DownloadType int downloadType, String downloadUrl, String fileName) {
        ...
        DownloadManager.Request request = new DownloadManager.Request(Uri.parse(downloadUrl))
                .setTitle(fileName)
                .setDestinationInExternalPublicDir(DOWNLOAD_PATH, fileName)
    ...
    public boolean fileExists(String name) {
        return new File(Environment.getExternalStorageDirectory() + DOWNLOAD_PATH + name).exists();
    }
    ...
    public String getFilePath(long id) {
        return Environment.getExternalStorageDirectory() + DOWNLOAD_PATH + getFileName(id);
    }
}
