...
abstract class BaseActivity : DaggerAppCompatActivity(), BaseViewFragmentHelper {
    ...
    override fun replacePushFragment(
        idFrameContainer: Int,
    ...
    override fun replacePopFragment(
        idFrameContainer: Int,
        baseFragment: BaseFragment<*>,
        withTag: String,
        anim: Anim
        ...
        consentInformation.requestConsentInfoUpdate(
            ...
            object : ConsentInfoUpdateListener {
                override fun onConsentInfoUpdated(consentStatus: ConsentStatus) {
                    when (consentStatus) {
                        ConsentStatus.PERSONALIZED -> ConsentInformation.getInstance(this@BaseActivity).consentStatus =
                            ConsentStatus.PERSONALIZED
                        ConsentStatus.NON_PERSONALIZED -> ConsentInformation.getInstance(this@BaseActivity).consentStatus =
                ...
                isUpdateAvailable?.let {
                    ...
                    val appUpdater = AppUpdater(this@BaseActivity)
                        ...
                        .setContentOnUpdateAvailable(
                            "Update " + latestVersion + " is available to download! " +
                        ...
                        .setButtonUpdateClickListener { _, _ ->
                            val intent = Intent(
                                Intent.ACTION_VIEW,
                                Uri.parse("https://play.google.com/store/apps/details?id=dreamlab.worldpics&hl=en_US")
                            )
